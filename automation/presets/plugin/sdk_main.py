...
The script:
  ...
  5. Fetches LLM config (Cloud: workspace.get_llm(), Local: agent-server settings or env)
  6. Fetches secrets (both modes via agent-server or Cloud API)
  7. Fetches MCP config (both modes via agent-server or Cloud API)
